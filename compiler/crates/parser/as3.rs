...
// sha3: b19fb6e2f11d8446f0947c5adbb0302e5ecfafa8aa5155b2cd5814a23b02fae5
use std::str::FromStr;
use conv::ValueFrom;
...
mod __parse__NumericLiteral {
    ...
    impl NumericLiteralParser {
        pub fn new() -> NumericLiteralParser {
    ...
    ) -> Option<Result<f64,__lalrpop_util::ParseError<usize, Token<'input>, &'static str>>>
    {
        let (__pop_states, __nonterminal) = match __action {
            ...
            1 => {
                // __NumericLiteral = NumericLiteral => ActionFn(0);
...
pub use self::__parse__NumericLiteral::NumericLiteralParser;
...
mod __intern_token {
    ...
    pub fn new_builder() -> __lalrpop_util::lexer::MatcherBuilder {
        let __strs: &[(&str, bool)] = &[
            ("^((?:0|((?:((?:((?:[1-9][0-9]*((?:_[0-9]+))*))((?:\\.((?:[0-9]+((?:_[0-9]+))*))?))))|((?:\\.[0-9]+((?:_[0-9]+))*))|((?:[Ee][\\+\\-]?[0-9]+((?:_[0-9]+))*))?))|((?:0[Xx][0-9A-Fa-f]+((?:_[0-9A-Fa-f]+))*))|((?:0[Bb][01]+((?:_[01]+))*))))", false),
            (r"^(\s*)", true),
        ];
