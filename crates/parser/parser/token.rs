...
impl ToString for Token {
    ...
    fn to_string(&self) -> String {
        (match self {
            ...
            Token::Descendants => "'..'",
            Token::Ellipsis => "'...'",
            Token::LeftParen => "paren-open",
            Token::RightParen => "paren-close",
            Token::LeftBracket => "square-open",
            Token::RightBracket => "square-close",
            Token::LeftBrace => "block-open",
            Token::RightBrace => "block-close",
            Token::Dot => "dot",
