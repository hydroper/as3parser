...
impl ToString for Token {
    ...
    /// * `"'punctuator'"` for various punctuators
    /// * `"punctuator"` for various punctuators
    /// * `"XML whitespace"`
    /// * `"'</'"`
    /// * `"'/>'"`
    ...
    fn to_string(&self) -> String {
        (match self {
            ...
            Token::Descendants => "'..'",
            Token::Ellipsis => "'...'",
            Token::LeftParen => "open-parenthesis",
            Token::RightParen => "close-parenthesis",
            Token::LeftBracket => "open-bracket",
            Token::RightBracket => "close-bracket",
            Token::LeftBrace => "open-brace",
            Token::RightBrace => "close-brace",
            Token::Dot => "dot",
            ...
            Token::Times => "times",
            Token::Div => "slash",
            Token::Remainder => "percent",
            Token::Increment => "'++'",
            Token::Decrement => "'--'",
            Token::LeftShift => "'<<'",
            Token::RightShift => "'>>'",
            Token::UnsignedRightShift => "'>>>'",
            Token::BitwiseAnd => "ampersand",
            Token::BitwiseXor => "'^'",
            Token::BitwiseOr => "'|'",
            Token::BitwiseNot => "'~'",
            Token::LogicalAnd => "'&&'",
